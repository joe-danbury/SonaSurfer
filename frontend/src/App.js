...
function PlaylistSkeleton() {
  return (
    <div className="pt-14 px-8 pb-8 flex gap-8 animate-pulse">
  ...
  return (
    <div className="min-h-screen bg-green-500 flex relative">
      ...
      <div className="absolute top-3 right-3 z-10">
        {isAuthenticated ? (
          <button
            ...
            className="px-3 py-1.5 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors text-xs shadow-sm"
          >
            Logout
          </button>
        ) : (
          <button
            onClick={handleLogin}
            className="px-4 py-2 bg-white text-green-500 rounded-lg hover:bg-white/90 transition-colors font-semibold text-sm shadow-sm"
          >
            Login with Spotify
          </button>
        )}
      ...
      <div className="w-1/2 flex flex-col h-screen">
        {/* Header */}
        <div className="border-b border-white/20 py-3 px-4">
      ...
      <div className="w-1/2 bg-white flex flex-col h-screen overflow-y-auto">
        {!playlist ? (
          ...
          <div className="pt-14 px-8 pb-8 flex gap-8">
